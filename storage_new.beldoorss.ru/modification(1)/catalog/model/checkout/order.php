...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
		...
		if (isset($data['totals'])) {
			...
			$send_ntf = $this->config->get('tlgrm_notification_status');
			$new_order = $this->config->get('tlgrm_notification_new_order');
			$tlgrm_send = $this->config->get('tlgrm_notification_send');
			$order_status_zero = $this->config->get('tlgrm_notification_template_order_status');
	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
		$order_info = $this->getOrder($order_id);
			...
			$new_order = $this->config->get('tlgrm_notification_new_order');
			$tlgrm_send = $this->config->get('tlgrm_notification_send');
			$manager = $this->config->get('tlgrm_notification_new_order_status');
			...
			if ($send_ntf == 1 && $manager == 1) { 
				$template_ntf = $this->config->get('tlgrm_notification_template_order_status');
