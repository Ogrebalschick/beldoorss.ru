        ...
        <div class="<?php echo $class; ?>">
            ...
            <?php } ?>
				...
				<?php if ($videos ) { ?>
					<?php foreach ($videos as $video) { ?>
						<li class="image-additional"><a rel="nofollow" class="thumbnail popup-youtube" href="https://www.youtube.com/watch?v=<?php echo $video['url']; ?>"><i class="fa fa-youtube-play" style="font-size:65px;" aria-hidden="true"></i>
						<img src="https://img.youtube.com/vi/<?php echo $video['url']; ?>/maxresdefault.jpg" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
						</a></li>
						<div itemscope itemtype="http://schema.org/VideoObject">
							<meta itemprop="name" content="<?php echo $heading_title; ?>">
							<meta itemprop="description" content="<?php echo $heading_title; ?>">
							<meta itemprop="thumbnailUrl" content="https://img.youtube.com/vi/<?php echo $video['url']; ?>/maxresdefault.jpg">
							<meta itemprop="contentURL" content="https://www.youtube.com/watch?v=<?php echo $video['url']; ?>">
							<meta itemprop="embedURL" content="https://www.youtube.com/embed/<?php echo $video['url']; ?>">
							<meta itemprop="uploadDate" content="<?php echo $date_added; ?>">
						</div>
						<script type="application/ld+json">
							...
							"thumbnailUrl": "https://img.youtube.com/vi/<?php echo $video['url']; ?>/maxresdefault.jpg",
							"contentUrl": "https://www.youtube.com/watch?v=<?php echo $video['url']; ?>",
							"embedUrl": "https://www.youtube.com/embed/<?php echo $video['url']; ?>",
							"uploadDate": "<?php echo $date_added; ?>"
							}
						</script>
					<?php } ?>
				<?php } ?>
          ...
          <ul class="nav nav-tabs">
            ...
            <?php if ($review_status) { ?>
					...
					<?php } ?>
            		<?php $item = 0; ?>
            		<?php foreach ($add_tabs as $tab) { ?>
					<li><a href="#tab-add-<?php echo $item; ?>" data-toggle="tab"><?php echo $tab['name']; ?></a></li>
					<?php $item = ($item + 1); ?>
					<?php } ?>
          ...
          <div class="tab-content">
            	...
            	<?php $item = 0; ?>
            	<?php foreach ($add_tabs as $tab) { ?>
				<div class="tab-pane" id="tab-add-<?php echo $item; ?>"><?php echo $tab['description']; ?></div>
				<?php $item = ($item + 1); ?>
				<?php } ?>
...
//-->
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              <select name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control">
                ...
                <option<?php if ($option_value['product_image_thumb']) { ?> data-product-image-thumb="<?php echo $option_value['product_image_thumb']; ?>"<?php } ?><?php if ($option_value['product_image_popup']) { ?> data-product-image-popup="<?php echo $option_value['product_image_popup']; ?>"<?php } ?> value="<?php echo $option_value['product_option_value_id']; ?>" data-points="<?php echo (isset($option_value['points_value']) ? $option_value['points_value'] : 0); ?>" data-prefix="<?php echo $option_value['price_prefix']; ?>" data-price="<?php echo $option_value['price_value']; ?>" data-link="<?php echo $option_value['link']; ?>" data-checked="<?php echo $option_value['checked'] ?>"><?php echo $option_value['name']; ?>
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              <div id="input-option<?php echo $option['product_option_id']; ?>">
                ...
                <div class="radio">
                  <label>
                    <input <?php if ($option_value['product_image_thumb']) { ?> data-product-image-thumb="<?php echo $option_value['product_image_thumb']; ?>"<?php } ?><?php if ($option_value['product_image_popup']) { ?> data-product-image-popup="<?php echo $option_value['product_image_popup']; ?>"<?php } ?>type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" data-points="<?php echo (isset($option_value['points_value']) ? $option_value['points_value'] : 0); ?>" data-prefix="<?php echo $option_value['price_prefix']; ?>" data-price="<?php echo $option_value['price_value']; ?>" data-link="<?php echo $option_value['link']; ?>" data-checked="<?php echo $option_value['checked'] ?>" />
            ...
            <div class="form-group required">
              <select name="recurring_id" class="form-control">
				...
				$(document).ready(function() {
					...
					options_image_setting.popup_element = "<?php echo $options_image_setting['product_popup_element']; ?>";
					options_image_setting.popup_attr    = "<?php echo $options_image_setting['product_popup_attr']; ?>";
					options_image_setting.thumb_element = "<?php echo $options_image_setting['product_thumb_element']; ?>";
					options_image_setting.thumb_attr    = "<?php echo $options_image_setting['product_thumb_attr']; ?>";
...
//--></script>
<?php if(!isset($microdatapro_main_flag)){echo $microdatapro;} //microdatapro 7.0 - 2 - extra ?>
