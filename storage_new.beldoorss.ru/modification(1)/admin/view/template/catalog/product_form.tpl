							...
							<tbody>
								...
								<?php foreach ($product_videos as $product_video) { ?>
									<tr id="video-row<?php echo $video_row; ?>">
										<td class="text-right"><input type="text" name="product_video[<?php echo $video_row; ?>][url]" value="<?php echo $product_video['url']; ?>" placeholder="<?php echo $entry_url; ?>" class="form-control" /></td>
            ...
            $('#' + option_row + ' .option_link_id').val("");
				...
				var video_row = <?php echo $video_row; ?>;
					function addVideo() {
						...
						html += '  <td class="text-right"><input type="text" name="product_video[' + video_row + '][url]" value="" placeholder="<?php echo $entry_url; ?>" class="form-control" /></td>';
						html += '  <td class="text-right"><input type="text" name="product_video[' + video_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
