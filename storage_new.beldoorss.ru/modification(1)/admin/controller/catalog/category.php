...
class ControllerCatalogCategory extends Controller {
	...
	protected function getList() {
		...
		$category_total = $this->model_catalog_category->getTotalCategories();
            ...
            if (isset($this->request->get['drag_sort']) && $this->request->get['drag_sort'] && isset($this->request->get['drag_sort_category'])) {
                ...
                $category_total = $this->model_catalog_drag_sort->getTotalCategoriesByParentId($this->request->get['drag_sort_category']);
                $results = $this->model_catalog_drag_sort->getCategoriesByParentId($this->request->get['drag_sort_category']);
            } else {
                $results = $this->model_catalog_category->getCategories($filter_data);
            }

            if (isset($this->request->get['drag_sort']) && $this->request->get['drag_sort'] && isset($this->request->get['drag_sort_category']) && $this->request->get['drag_sort_category'] != '0') {

                $curr_category = $this->model_catalog_category->getCategory($this->request->get['drag_sort_category']);

                $data['button_back'] = $this->url->link('catalog/category', 'sort=sort_order&order=ASC&drag_sort=1&drag_sort_category=' . $curr_category['parent_id'] . '&token=' . $this->session->data['token'], true);
            } else {
                $data['button_back'] = '';
            }
		...
		foreach ($results as $result) {
            ...
            'href' => isset($result['children']) && $result['children'] ? $this->url->link('catalog/category', 'sort=sort_order&order=ASC&drag_sort=1&drag_sort_category=' . $result['category_id'] . '&token=' . $this->session->data['token'], true) : '',
		...
		if (isset($this->request->get['order'])) {
            ...
            if (!isset($this->request->get['drag_sort_category'])) {
                $drag_url .= '&drag_sort_category=0';
            }

            $data['drag_sort_mode_link'] = $this->url->link('catalog/category', 'sort=sort_order&order=ASC&drag_sort=1' . $drag_url . '&token=' . $this->session->data['token'], true);
            ...
            $data['drag_sort_category'] = isset($this->request->get['drag_sort_category']) ? $this->request->get['drag_sort_category'] : '0';
            $data['token'] = $this->session->data['token'];
            $data['min_sort'] = ($category_total) ? ((($page - 1) * $this->config->get('config_limit_admin')) + 1) * 2 - 1 : 0;

            if ($url == '&sort=sort_order&order=ASC' && isset($this->request->get['drag_sort']) && $this->request->get['drag_sort']) {
                $url .= '&drag_sort=1';
            }
