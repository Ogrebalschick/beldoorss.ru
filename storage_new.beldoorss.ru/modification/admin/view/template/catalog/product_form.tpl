...
<div class="tab-pane" id="tab-tabs">
			        <div class="row">
			            <div class="col-sm-2">
		                 <div id="alert" class="alert alert-info hide" style="overflow: hidden;">
                            TABS | by <a rel="nofollow noopener" target="_blank" href="https://ocprofi.net" title="ocProfi.net">ocProfi.net</a>
                        <button type="button" class="close" data-dismiss="alert" title="Больше не показывать" aria-label="Close">
			            		...
			            		<?php foreach ($tabs_data as $tab) { ?>
				            		<li>
				            			<span class="btn-group">
				            				<a class="btn btn-primary" href="#add-tab-<?php echo $item; ?>" data-toggle="tab"><?php echo $text_new_tab; ?><?php echo $item; ?></a>
				            				<button class="btn btn-default" type="button" onclick="removeTab(<?php echo $item; ?>)"><i class="fa fa-close"></i></button>
				            			<span>
				            		</li>
			            			<?php $item = ($item + 1); ?>
			            		<?php } ?>
			            		<li>
			            			<button type="button" class="btn btn-danger btn-block" data-item="<?php echo $item; ?>" onclick="addNewTab(this)">
			            				<?php echo $text_add_new_tab; ?>
			            			</button>
			            		</li>
			            	</ul>
			            </div>
			            <div class="col-sm-10">
			            	...
			            	<div class="tab-content">
								<?php $item = 0; ?>
			            		<?php foreach ($tabs_data as $tab) { ?>
			            			<?php (isset ($tab['cross'])) ? $cross = $tab['cross'] : $cross =  false; ?>
				            		<div class="tab-pane fade" id="add-tab-<?php echo $item; ?>">
				            			<ul class="nav nav-tabs">
				            				<?php foreach ($languages as $language) { ?>
				            				<li>
				            					<a href="#add-tab-item-<?php echo $item; ?>-language-<?php echo $language['language_id']; ?>" data-toggle="tab" title="<?php echo $language['name']; ?>">
				            			...
				            			<div class="tab-content">
						            		<label class="switch">
												<input type="checkbox" class="switch-input" <?php if ($cross == true) { ?> checked <?php } ?> name="add_tabs[<?php echo $item; ?>][cross]" value="1">
												<span class="switch-label" data-on="<?php echo $text_tab_cross_on; ?>" data-off="<?php echo $text_tab_cross_off; ?>"></span> 
												<span class="switch-handle"></span> 
											</label>				            			                                                                              				
				            				<?php foreach ($languages as $language) { ?>
				            				<div class="tab-pane fade" id="add-tab-item-<?php echo $item; ?>-language-<?php echo $language['language_id']; ?>">	
												
												<div class="input-group">
												  	<span class="input-group-addon"><?php echo $text_tab_name; ?></span>
												  	<input type="text" class="form-control add-tab-name" name="add_tabs[<?php echo $item; ?>][<?php echo $language['language_id']; ?>][name]" value="<?php echo $tab[$language['language_id']]['name']; ?>">	
												</div>
												
												<textarea class="form-control summernote" name="add_tabs[<?php echo $item; ?>][<?php echo $language['language_id']; ?>][description]" id="input-description"><?php echo $tab[$language['language_id']]['description'] ; ?></textarea>
												
												<div class="input-group">
													<span class="input-group-addon"><?php echo $text_tab_sort_order; ?></span>
													<input type="number" class="form-control" name="add_tabs[<?php echo $item; ?>][<?php echo $language['language_id']; ?>][sort_order]" value="<?php echo $tab[$language['language_id']]['sort_order']; ?>">
												</div>
											</div>
											<?php } ?>
										</div>
			        ...
			        <script>
			        	var addNewTab, removeTab;
			        	$(() => {
				        	let summernoteInit = (element) => 
				        	{
								$(element).summernote({
				        	...
				        	addNewTab = function(self) 
				        	{
				        		...
				        		`<li>
			            			<span class="btn-group">
			            				<a class="btn btn-primary active" href="#add-tab-`+ item +`" data-toggle="tab">
			            					<?php echo $text_new_tab; ?>`+ item +`
			            				</a>
			            				<button class="btn btn-danger" type="button" onclick="removeTab(`+ item +`)">
				            	...
				            	content = 
				            	`<div class="tab-pane fade" id="add-tab-`+ item +`">
			            			<ul class="nav nav-tabs">
			            				<?php foreach ($languages as $language) { ?>
			            				<li>
			            					<a href="#add-tab-item-`+ item +`-language-<?php echo $language['language_id']; ?>" data-toggle="tab" title="<?php echo $language['name']; ?>">
			            						<img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" />
			            					</a>
			            				</li>
			            				<?php } ?>
			            			...
			            			<div class="tab-content">	
										<label class="switch">
											<input type="checkbox" class="switch-input" name="add_tabs[`+ item +`][cross]" value="1">
											<span class="switch-label" data-on="<?php echo $text_tab_cross_on; ?>" data-off="<?php echo $text_tab_cross_off; ?>"></span> 
											<span class="switch-handle"></span> 
										</label>			            				
			            				<?php foreach ($languages as $language) { ?>
			            				<div class="tab-pane fade" id="add-tab-item-`+ item +`-language-<?php echo $language['language_id']; ?>">	
											
											<div class="input-group">
											  	<span class="input-group-addon"><?php echo $text_tab_name; ?></span>
											  	<input type="text" class="form-control add-tab-name" name="add_tabs[`+ item +`][<?php echo $language['language_id']; ?>][name]" value="">	
											</div>
								
											<textarea class="form-control summernote" name="add_tabs[`+ item +`][<?php echo $language['language_id']; ?>][description]" id="input-description<?php echo $language['language_id']; ?>"></textarea>
											
											<div class="input-group">
												<span class="input-group-addon"><?php echo $text_tab_sort_order; ?></span>
												<input type="number" class="form-control" name="add_tabs[`+ item +`][<?php echo $language['language_id']; ?>][sort_order]">	
											</div>
				            	...
				            	$self.closest('li').before(tab);
				            	$(content).appendTo($self.closest('.row').find('.tab-content').eq(0));

				            	$('.nav-stacked a[href*="add-tab-"]:last').tab('show');
				            	$('a[href*="#add-tab-item-'+ item +'"]:first').tab('show');

				            	$('div[id*="add-tab-item-'+ item +'"] textarea').each(function () {
				            		summernoteInit($(this));
				            	});
				        	...
				        	{
				        		$('.nav-stacked a[href="#add-tab-'+ tab_item +'"]').closest('li').remove();
				        		$("#add-tab-"+ tab_item).remove();

				        		$('.nav-stacked a[href*="add-tab-"]:first').tab('show');
				        		$('a[href*="#add-tab-item-"]:first').tab('show');
				        	};
			        	});
			        	/* run */
			        	$(() => {
				        	...
				        	$('div[id*="add-tab-"]').each(function() {
				        		$(this).find('[data-toggle="tab"]').eq(0).tab('show');
				        	});
				        });
				        /* run */
			        ...
			        <style>
			        	#tab-tabs .nav.nav-pills.nav-stacked .btn-group { width: 100%; }
			        	#tab-tabs .nav.nav-pills.nav-stacked .btn-group a { width: 80%; text-align: left; }
			        	#tab-tabs .nav.nav-pills.nav-stacked .btn-group button { width: 20%; }
			        	#tab-tabs .input-group { margin-bottom: 15px; }
			        	#tab-tabs .nav li.active a { font-weight:bold;}
						...
						#tab-tabs .switch-label {
							...
							box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.12), inset 0 0 2px rgba(0, 0, 0, 0.05);
							box-sizing:content-box;
							margin-top: -3px;
						}
						#tab-tabs .switch-label:before, 
						#tab-tabs .switch-label:after {
							position: absolute;
							top: 50%;
							margin-top: -.5em;
							line-height: 1;
						...
						#tab-tabs .switch-input:checked ~ .switch-label {
							background: #37A7D4;
							box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.15), inset 0 0 3px rgba(0, 0, 0, 0.2);
						}
						#tab-tabs .switch-input:checked ~ .switch-label:before {
							opacity: 0;
						}
						#tab-tabs .switch-input:checked ~ .switch-label:after {
							opacity: .9;
						}
						#tab-tabs .switch-handle {
							position: absolute;
							top: 1px;
							left: 4px;
							width: 28px;
						...
						#tab-tabs .switch-input:checked ~ .switch-handle {
							left: 124px;
...
<td class="text-right"><?php echo $entry_link; ?></td>
                              <td class="text-center"><?php echo $entry_image; ?></td><td class="text-right"><?php echo $entry_quantity; ?></td>
             ...
             <td class="text-left">
              <input type="hidden" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][link]" value="<?php echo $product_option_value['link'] ?>" class="option_link_id"/>
              <input type="text" name="" value="<?php echo $product_option_value['link_label'] ?>" placeholder="<?php echo $entry_link ?>" class="form-control option_link_text" style="display:inline;width:70%"/>
              <button style="vertical-align:unset" type="button" onclick="$('#option-value-row<?php echo $option_value_row; ?> .option_link_text').val('');$('#option-value-row<?php echo $option_value_row; ?> .option_link_id').val('');" title="" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
              <br/><label class="radio-inline" style="padding-left:0;padding-top:0;"><input type="checkbox" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][checked]" <?php if ($product_option_value['checked']) {?>checked="checked"<?php } ?>> <?php echo $entry_checked ?></label>
             </td>
           

				<td class="text-center">
				  <a href="" id="product-option-thumb-image<?php echo $option_row; ?><?php echo $option_value_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $product_option_value['product_image_thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
				  <input type="hidden" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][product_image]" value="<?php echo $product_option_value['product_image']; ?>" id="input-product-option-image<?php echo $option_row; ?><?php echo $option_value_row; ?>" />
				</td>
				...
				<div class="tab-pane" id="tab-video">
					<div class="table-responsive">
						<table id="videos" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<td class="text-left"><?php echo $entry_url; ?> (ID Rutube или ссылка)</td>
									<td class="text-left"><?php echo $entry_preview; ?> (необязательно, ссылка на картинку)</td>
							...
							<tbody>
								...
								<?php foreach ($product_videos as $product_video) { ?>
									<tr id="video-row<?php echo $video_row; ?>">
										<td><input type="text" name="product_video[<?php echo $video_row; ?>][url]" value="<?php echo $product_video['url']; ?>" class="form-control" /></td>
										<td><input type="text" name="product_video[<?php echo $video_row; ?>][preview]" value="<?php echo isset($product_video['preview']) ? $product_video['preview'] : ''; ?>" class="form-control" /></td>
										<td><input type="text" name="product_video[<?php echo $video_row; ?>][sort_order]" value="<?php echo $product_video['sort_order']; ?>" class="form-control" size="3" /></td>
										<td><button type="button" onclick="$('#video-row<?php echo $video_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
									</tr>
								<?php $video_row++; ?>
								<?php } ?>
							</tbody>
            ...
            <div class="tab-pane" id="tab-image">
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      <td class="text-left"><a href="" id="thumb-image" data-toggle="image" class="multiple img-thumbnail"><img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="image" value="<?php echo $image; ?>" id="input-image" /></td>

            <?php if ($implus_image_folder) {?>
            <input type="hidden" id="elfinder-imaage-path" value="<?php echo $image_hash; ?>" id="input-image" />
            <?php } ?> 
              ...
              <div class="table-responsive">
                <table id="images" class="table table-striped table-bordered table-hover">
                 ...
                 <?php if ($implus_status) {?><td class="text-left"><?php echo $entry_default_image; ?></td><?php } ?> 
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                      <td class="text-left"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="multiple img-thumbnail"><img src="<?php echo $product_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_image[<?php echo $image_row; ?>][image]" value="<?php echo $product_image['image']; ?>" id="input-image<?php echo $image_row; ?>" /></td>
                      <td class="text-right"><input type="text" name="product_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $product_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>

           <?php if ($implus_status) {?><td class="text-left"><input class="form-control" type="radio" name="implus_default_img" value="<?php  echo $product_image['image']; ?>" style="float: left;"><span style="margin-left: 10px;"><?php if ($image == $product_image['image']) { echo $entry_default_image_selected; } ?></span></td><?php } ?>   
                  ...
                  <tfoot>
                    <tr>
                      <td <?php if ($implus_status) {?>colspan="3"<?php } else {?> colspan="2" <?php } ?>></td>
...
html += '        <td class="text-right"><?php echo $entry_link; ?></td>';
			html += '        <td class="text-center"><?php echo $entry_image; ?></td><td class="text-right"><?php echo $entry_quantity; ?></td>';
...
function addOptionValue(option_row) {
	...
	html += '  </select><input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][product_option_value_id]" value="" /></td>';
             ...
             html += '<td class="text-left">';
             html += '<input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][link]" value="" class="option_link_id"/>';
             html += '<input style="display:inline;width:70%" type="text" name="" value="" placeholder="<?php echo $entry_link ?>" class="form-control option_link_text" />';
             html += '<button style="vertical-align:unset" type="button" onclick="$(\'#option-value-row' + option_value_row + ' .option_link_text\').val(\'\');$(\'#option-value-row' + option_value_row + ' .option_link_id\').val(\'\');" title="" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>';
             html += '<br/><label class="radio-inline" style="padding-left:0;padding-top:0;"><input type="checkbox" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][checked]"> <?php echo $entry_checked ?></label>';
             html += '</td>';
           

			    html += '<td class="text-center"><a href="" id="product-option-thumb-image' + option_row + option_value_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][product_image]" value="" id="input-product-option-image'+ option_row + option_value_row + '" /></td>';
	...
	$('[rel=tooltip]').tooltip();
             ...
             optionautocomplete('option-value-row' + option_value_row);
...
var image_row = <?php echo $image_row; ?>;
        ...
        function add_multiple(path, file) {
          html  = '<tr id="image-row' + image_row + '">';
          html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="multiple img-thumbnail"><img src="' + file +'"" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_image[' + image_row + '][image]" value="' + path +'" id="input-image' + image_row + '" /></td>';
          html += '  <td class="text-right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';

              <?php if ($implus_status) {?>html += '<td><input type="radio" name="implus_default_img" id="radio_' + image_row + '" value="" disabled="disabled"></td>';<?php } ?>
...
function addImage() {
	html  = '<tr id="image-row' + image_row + '">';
	html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="multiple img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
	html += '  <td class="text-right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
...
//--></script></div>
  ...
  <!-- OCFilter end -->
             ...
             <script>
               function optionautocomplete(option_row) {    
            $('#' + option_row + ' .option_link_text').autocomplete({
              'source': function(request, response) {
                $.ajax({
                  url: 'index.php?route=catalog/product/autocomplete&token=<?php echo $token ?>&filter_name=' + encodeURIComponent(request),
                  dataType: 'json',
              ...
              'select': function(item) {
                $('#' + option_row + ' .option_link_text').val(item['label']);
                $('#' + option_row + ' .option_link_id').val(item['value']);
              }
            });
          }         
          $('#tab-option tbody tr').each(function(index, element) {
           optionautocomplete($(this).attr("id"));
          });
          
          function optionlinkdelete(option_row) {
              $('#' + option_row + ' .option_link_text').val("");
            $('#' + option_row + ' .option_link_id').val("");
          }     
             </script>
				...
				function addVideo() {
					...
					html += '<td><input type="text" name="product_video[' + video_row + '][url]" value="" class="form-control" /></td>';
					html += '<td><input type="text" name="product_video[' + video_row + '][preview]" value="" class="form-control" /></td>';
					html += '<td><input type="text" name="product_video[' + video_row + '][sort_order]" value="" class="form-control" size="3" /></td>';
					html += '<td><button type="button" onclick="$(\'#video-row' + video_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
					html += '</tr>';
