<?php
				...
				$_['tab_video'] = 'Видео Rutube';
				$_['entry_url'] = 'ID видео или ссылка';
				$_['entry_preview'] = 'Превью (URL)';
			
// Heading
$_['heading_title']          = 'Товары';

// Text
$_['text_tabs']            = 'Дополнительные вкладки';
            	$_['text_new_tab']         = 'Новая вкладка #';
            	$_['text_tab_cross_on']	   = 'Для всех товаров';
				$_['text_tab_cross_off']   = 'Для этого товара'; 
				$_['text_tab_name']		   = 'Название вкладки';
				$_['text_add_new_tab']	   = 'Добавить вкладку';
				$_['text_tab_sort_order']  = 'Порядок сортировки';
...
$_['entry_main_category']    = 'Главная категория:';
           ...
           $_['entry_link']         = 'Товар';
           $_['entry_checked']      = 'По умолчанию';
           

              $_['entry_default_image']  = 'Default Image:';
              $_['entry_default_image_selected']  = 'This image is set as default image.';
