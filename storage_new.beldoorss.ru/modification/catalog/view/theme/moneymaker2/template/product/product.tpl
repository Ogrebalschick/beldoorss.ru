        ...
        <div class="row">
            ...
            <?php if ($videos) { ?>
                <?php foreach ($videos as $video) { ?>
                    <a class="item thumbnail rutube-video-popup" href="<?php echo $video['embed_url']; ?>" style="position:relative; display:inline-block;">
                        <img class="img-circle" src="<?php echo $video['preview']; ?>" alt="Видео товара" />
                        <i class="fa fa-play-circle" style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); font-size:36px; color:#fff; text-shadow:1px 1px 2px #000;"></i>
                    </a>
                <?php } ?>
            <?php } ?>
                                            ...
                                            <?php foreach ($options as $option_key => $option) { ?>
                                                <?php if ($option['type'] == 'radio') { ?>
                                                    <div class="product__types radioblock-<?php echo $option_key; ?>">
                                                        ...
                                                        <?php } ?>
                                                        <?php if (strpos($option['name'], 'Цвет') === 0 && $option['product_option_id'] != 5253) { ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if (strpos($option['name'], 'Цвета') === 0 && $option['product_option_id'] == 5253) { ?>
                                                            <div class="optionColor form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                                                <label class="control-label">
                                                                    <?php echo $option['name']; ?>
                                                                </label>
                                                        ...
                                                        <?php } ?>
                                                                                                                <?php if (strpos($option['name'], 'ЦВЕТ-РЕГИОНЫ') === 0) { ?>
                                                            <div class="optionColor form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                                                <label class="control-label">
                                                                    Цвет
                                                                </label>
                                                        ...
                                                        <?php } ?>
                                                        <?php if (strpos($option['name'], 'Зеркало') === 0) { ?>
                                                            <div class="optionMirror optionSize form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                                                <label class="control-label">
                                                                    <?php echo $option['name']; ?>
                                                                </label>
                                                                <div id="input-option<?php echo $option['product_option_id']; ?>">
                                            ...
                                            <?php if (!$product_sold) { ?>
                                                ...
                                                data-order-price="
                                                    ...
                                                    <?php } else if ($price) { ?>
                                                        <?php echo strip_tags($price); ?>
                                                    <?php } ?>"
                                                onclick="ym(55350583,'reachGoal','OrderMeasurements'); return true;"
                                            <?php } ?>>
                                            <span <?php if (strip_tags($quickorder_tooltip)) { ?> 
                                                data-toggle="tooltip" 
                                                data-html="true" 
            ...
            <li class="active"><a href="#tab-description" data-toggle="tab" itemprop="description"><?php echo $tab_description; ?></a></li>
           ...
           <script>
			...
			$('#product input[type=checkbox]').on('change', function () {
				...
				<?php if ($videos) { ?>
					...
					<script>
						$(document).ready(function() {
							$('.rutube-video-popup').magnificPopup({
								type: 'iframe',
								iframe: {
									patterns: {
										rutube: {
