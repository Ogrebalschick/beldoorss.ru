		...
		/*mmr*/
			...
			if ($product_info['image']) {
				...
				foreach ($results as $result) {
					// Извлекаем ID Rutube из ссылки, если введена полная
					$url = $result['url'];
					...
					$preview = !empty($result['preview']) ? $result['preview'] : 'https://preview.rutube.ru/preview/' . $video_id . '.webp?width=300';
					$data['videos'][] = array(
						'embed_url' => $embed_url,
						'preview'   => $preview,
				...
				// Сортировка по sort_order (если нужно)
