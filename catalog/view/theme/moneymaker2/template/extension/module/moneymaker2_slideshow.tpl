...
<script><!--
  ...
  itemsCustom : 
    [
        [0, 1], 
        [320, <?php echo isset($items['xxxsm']) ? $items['xxxsm'] : 1; ?>], 
        [450, <?php echo isset($items['xxsm']) ? $items['xxsm'] : 1; ?>], 
        [560, <?php echo isset($items['xsm']) ? $items['xsm'] : 1; ?>], 
        [768, <?php echo $items['sm']; ?>], 
        [992, <?php echo $items['md']; ?>], 
        [1200, <?php echo $items['lg']; ?>]
    ],
    <?php if ($animation) { ?>
