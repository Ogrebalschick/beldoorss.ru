...
<section class="special" style="height:auto;">
        <div class="container">
            <div class="special__inner">
                ...
                <div class="special-image" style="position:initial;"><img src="https://beldoorss.ru/image/category/interior-doors/special-doors.jpg" alt=""></div>
            </div>
        </div>
    </section>
<div class="container">
<embed src="/docs/mezhkomnatnye-peregorodki.pdf#view=FitH&amp;toolbar=0&amp;navpanes=0" type="application/pdf" width="100%" height="900px">
</div>
<script>
