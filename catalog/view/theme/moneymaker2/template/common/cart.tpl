<span class="dropdown" id="cart">
    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" role="button" aria-haspopup="true" aria-expanded="false">
        <img src="catalog/view/theme/moneymaker2/image/svg/cart.svg">
        <small class="fa-stack">
            <span class="fa-stack-1x"><?php echo $text_items_count; ?></span>
        </small> 
        <span class="<?php echo $moneymaker2_header_strip_cart_class; ?>">
