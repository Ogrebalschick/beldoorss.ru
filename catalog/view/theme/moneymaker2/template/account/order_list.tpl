        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right"><a href="<?php echo $order['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="text-nowrap"><i class="fa fa-file-text"></i> <?php echo $button_view; ?></a></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
