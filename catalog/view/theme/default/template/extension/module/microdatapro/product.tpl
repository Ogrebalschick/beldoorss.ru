...
<meta itemprop="name" content="<?php echo $name; ?>" />
<meta itemprop="description" content="<?php echo $name; ?>" />
<link itemprop="thumbnailUrl" href="<?php echo str_replace(array('id=','"',"'",'mainimage','selector'), "", $image['thumb']); ?>" />
<link itemprop="contentUrl" href="<?php echo str_replace(array('id=','"',"'",'mainimage','selector'), "", $image['popup']); ?>" />
<meta itemprop="author" content="<?php echo $author; ?>" />
<meta itemprop="datePublished" content="<?php echo $date_added; ?>">
</span>
<?php } ?>
...
"@type": "ImageObject",
"author": "<?php echo $author; ?>",
"thumbnailUrl": "<?php echo str_replace(array('id=','"',"'",'mainimage','selector'), "", $image['thumb']); ?>",
"contentUrl": "<?php echo str_replace(array('id=','"',"'",'mainimage','selector'), "", $image['popup']); ?>",
"datePublished": "<?php echo $date_added; ?>",
"description": "<?php echo $name; ?>",
"name": "<?php echo $name; ?>"
