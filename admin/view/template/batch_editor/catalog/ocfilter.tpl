  ...
  <tfoot>
   <tr>
    <td class="center">
     ...
     <a class="btn btn-success" onclick="editLink('ocfilter', 'upd', <?php echo $product_id; ?>);"><?php echo $button_save; ?></a>
 ...
 <table class="be-list">
  <tfoot>
   <tr>
    ...
    <td class="center"><a class="btn btn-success" onclick="editLink('ocfilter', 'upd', <?php echo $product_id; ?>);"><?php echo $text_edit; ?></a></td>
   </tr>
  </tfoot>
 </table>
</form>
...
function addOcFilter() {
	...
	html += ' <tr>';
	html += '  <td style="width:1px;"><a onclick="$(\'#form-ocfilter<?php echo $product_id; ?> #ocfilter-row' + ocfilter_row + '\').remove();" href="javascript:return false;" class="btn btn-danger btn-xs" title="<?php echo $button_remove; ?>"><i class="fa fa-minus"></i></a></td>';
