                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        ...
                        <select class="form-control input-sm" id="select-action-1" name="action">
                          ...
                          <?php echo ($setting['action']==1)?'selected':''?>>Добавлять</option>
                          <option value="2" style="color: #a94442;"
                          <?php echo ($setting['action']==2)?'selected':''?>>Обновлять</option>
                          <option value="3"
                          <?php echo ($setting['action']==3)?'selected':''?>>Добавлять и обновлять</option>
                        </select>
                      </div>
                      <div class="col-sm-3">
                        <label class="control-label" for="sku2">Идентификатор товара</label>
                        <select class="form-control input-sm" id="sku2" name="sid">
                          <option value="sku" <?php echo ($setting['sid']=='sku')?'selected':''?>>Артикул [sku]</option>
                          <option value="model" <?php echo ($setting['sid']=='model')?'selected':''?>>Код товара [model]</option>
                          <option value="name" <?php echo ($setting['sid']=='name')?'selected':''?>>Название [name] НЕ РЕКОМЕНДУЕТСЯ</option>
                          <option value="-" disabled="">Дополнительные идентификаторы. (Вкладка данные)</option>
                          <option value="upc" <?php echo ($setting['sid']=='upc')?'selected':''?>>Универсальный код [upc]</option>
                          <option value="ean" <?php echo ($setting['sid']=='ean')?'selected':''?>>Европейский номер товара [ean]</option>
                          <option value="jan" <?php echo ($setting['sid']=='jan')?'selected':''?>>Японский штрихкод [jan]</option>
                          <option value="isbn" <?php echo ($setting['sid']=='isbn')?'selected':''?>>Номер книжного издания [isbn]</option>
                          <option value="mpn" <?php echo ($setting['sid']=='mpn')?'selected':''?>>Номер партии [mpn]</option>
                          <option value="location" <?php echo ($setting['sid']=='location')?'selected':''?>>Поле расположение [location]</option>
                      ...
                      <div class="col-sm-2">
                        ...
                        <div class="checkselect">
                          <?php foreach ($langs as $lang) {?>
                            <label>
                              <input type="checkbox" name="r_lang[]" value="<?php echo $lang['language_id']?>" <?php echo ($lang['checked'])?'checked':''?>><?php echo $lang['name']?>
                            </label>
                          <?php }?>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        ...
                        <div class="checkselect">
                          ...
                          <label><input type="checkbox" name="r_store[]" value="<?php echo $stor['store_id']?>" <?php echo ($stor['checked'])?'checked':''?>><?php echo $stor['name']?></label>
                          <?php }?>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-5">
                        <a class="btn btn-primary btn-sm" type="button" style="margin-top: 25px"
                           href="<?php echo @$href_show?>"><i class="fa fa-eye" aria-hidden="true"></i> Пред просмотр</a>
                      ...
                      <div class="col-sm-2">
                        ...
                        <input class="form-control input-sm" name="pars_pause" type="text"
                               value="<?php echo $setting['pars_pause']?>">
                      </div>
                      <div class="col-sm-3">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="row">
                      <div class="col-sm-2">
                        <ul class="nav nav-pills nav-stacked" id="option">
                          ...
                          <li><a href="#tab-option11" data-toggle="tab" aria-expanded="true"> Файлы</a></li>
                          <li><a href="#tab-option12" data-toggle="tab" aria-expanded="true"> Данные</a></li>
                        </ul>
                      </div>
                      <div class="col-sm-10">
                        <div class="tab-content">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <select name="rules[model]" id="action-1" class="form-control">
                                  <option value="1"
                                  <?php echo ($setting['r_model']==1)?'selected':''?>>Создавать по умолчанию [Работает
                                  только при добавлении товара]</option>
                                  <option value="2"
                                  <?php echo ($setting['r_model']==2)?'selected':''?>>Парсить [Работает только при
                                ...
                                <select class="form-control" id="value-border-4"
                                  ...
                                  <?php foreach($params as $param){ ?>
                                    <option value="{gran_<?php echo $param['id']?>}">
                                      <?php echo $param['name']. '| {gran_'.$param['id'].'}'?>
                                    </option>
                                  <?php }?>
                                </select>
                              </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <select name="rules[sku]" id="" class="form-control">
                                  <option value="0"
                                  <?php echo ($setting['r_sku'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1"
                                  <?php echo ($setting['r_sku'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <select name="rules[name]" id="to-renew-1" class="form-control">
                                  <option value="0"
                                  <?php echo ($setting['r_name'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1"
                                  <?php echo ($setting['r_name'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <select name="rules[price]" id="to-renew-2" class="form-control">
                                  <option value="1" <?php echo ($setting['r_price']==1)?'selected':''?>>Обновлять</option>
                                  <option value="0" <?php echo ($setting['r_price']==0)?'selected':''?>>Не обновлять</option>
                                  <option value="2" <?php echo ($setting['r_price']==2)?'selected':''?>>Обновлять если цена выросла</option>
                                  <option value="3" <?php echo ($setting['r_price']==3)?'selected':''?>>Обновляет если цена упала</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <select name="r_price_spec" id="to-renew-2" class="form-control">
                                  <option value="0" <?php echo ($setting['r_price_spec']==0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_price_spec']==1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input id="price_spec" class="form-control" name="price_spec" type="text"
                                       value="<?php echo @$setup['price_spec']?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                                <select class="form-control" id="value-border-4"
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_price_spec_groups">
                                  <option value="all"<?php echo (!empty($setting['r_price_spec_groups']) && $setting['r_price_spec_groups'] == 'all')?'selected':''?>>Все группы</option>
                                  <?php foreach($cast_groups as $cast_id => $cast_group){?>
                                  <option value="<?php echo $cast_id?>"<?php echo (!empty($setting['r_price_spec_groups']) && $setting['r_price_spec_groups'] == $cast_id)?'selected':''?>><?php echo $cast_group?></option>
                                  <?php }?>
                                </select>
                              </div>
                              <label class="col-sm-2 control-label">Начало Акции:</label>
                              <div class="col-sm-2">
                                <input type="date" name="r_price_spec_date_start" value="<?php echo $setting['r_price_spec_date_start'];?>" data-date-format="YYYY-MM-DD"/>
                              </div>
                              <label class="col-sm-2 control-label">Конец Акции:</label>
                              <div class="col-sm-2">
                                <input type="date" name="r_price_spec_date_end" value="<?php echo $setting['r_price_spec_date_end'];?>" data-date-format="YYYY-MM-DD"/>
                              </div>
                            </div>
                          </div>
                          <!--Количество quant-->
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <select name="rules[quant]" id="to-renew-3" class="form-control">
                                  <option value="0"
                                  <?php echo ($setting['r_quant']==0)?'selected':''?>>Не обновлять</option>
                                  <option value="1"
                                  <?php echo ($setting['r_quant']==1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <select name="u_manufac" id="action-2" class="form-control">
                                  <option value="0" <?php echo ($setting['u_manufac']==0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['u_manufac']==1)?'selected':''?>>Создавать и обновлять в товаре, если новое значение</option>
                                  <option value="2" <?php echo ($setting['u_manufac']==2)?'selected':''?>>Обновлять в товаре если новый производитель и он уже создан в магазин</option>
                                </select>
                              </div>
                              ...
                              <div class="col-sm-4">
                                <select name="rules[manufac]" id="action-2" class="form-control">
                                  <option value="0" <?php echo ($setting['r_manufac']==0)?'selected':''?>>Не учитывать</option>
                                  <option value="1" <?php echo ($setting['r_manufac']==1)?'selected':''?>>Создавать, добавлять в товар</option>
                                  <option value="2" <?php echo ($setting['r_manufac']==2)?'selected':''?>>Добавлять в товар если уже создан в магазине</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <select class="form-control" name="manufac_d">
                                  <option value="0"
                                  <?php echo (!empty($setup['manufac_d']) && $setup['manufac_d']==0)?'selected':''?>
                                  >Производитель по умолчанию</option>
                                  <?php foreach($manufs as $manuf){?>
                                  <option value="<?php echo $manuf['id']?>"<?php echo (!empty($setup['manufac_d']) && $setup['manufac_d'] == $manuf['id'])?'selected':''?>><?php echo $manuf['name']?></option>
                                  <?php }?>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select name="r_manufac_made_url" class="form-control" id="value-border-3">
                                  <option value="1"
                                  <?php echo ($setting['r_manufac_made_url'] == 1)?'selected':''?>>Формировать из
                                  названия</option>
                                  <option value="2"
                                  <?php echo ($setting['r_manufac_made_url'] == 2)?'selected':''?>>По SEO
                                  шаблону</option>
                                  <option value="0"
                                  <?php echo ($setting['r_manufac_made_url'] == 0)?'selected':''?>>Не создавать</option>
                                </select>
                              </div>
                              ...
                              <div class="col-md-2">
                                <select name="r_manufac_made_meta" class="form-control">
                                  <option value="0"
                                  <?php echo ($setting['r_manufac_made_meta'] == 0)?'selected':''?>>Не
                                  заполнять</option>
                                  <option value="1"
                                  <?php echo ($setting['r_manufac_made_meta'] == 1)?'selected':''?>>По SEO
                                  шаблону</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <select name="u_des" id="to-renew-4" class="form-control">
                                  <option value="0"<?php echo ($setting['u_des']==0)?'selected':''?>>Не обновлять</option>
                                  <option value="1"<?php echo ($setting['u_des']==1)?'selected':''?>>Обновлять заменив полностью</option>
                                  <option value="2"<?php echo ($setting['u_des']==2)?'selected':''?>>Обновлять добавив в начало существующего описания</option>
                                  <option value="3"<?php echo ($setting['u_des']==3)?'selected':''?>>Обновлять добавив в конец существующего описания</option>
                                </select>
                              </div>
                              ...
                              <div class="col-sm-4">
                                <select name="rules[des]" id="to-renew-4" class="form-control">
                                  <option value="0" <?php echo ($setting['r_des']==0)?'selected':''?>>Не заполнять</option>
                                  <option value="1" <?php echo ($setting['r_des']==1)?'selected':''?>>Заполнять</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <textarea id="des" name="des" rows="3"
                                  class="col-sm-6 form-control"><?php echo @$setup['des']?></textarea>
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                                <select class="form-control" id="value-border-4"
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <textarea id="des_d" class="form-control"
                                          name="des_d"><?php echo @$setup['des_d']?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <label class="radio-inline">
                                  <input type="radio" name="rules[des_dir]" value="1" <?php echo ($setting['r_des_dir']==1)?'checked':''?>>Да 
                                </label>
                                <label class="radio-inline">
                                  <input type="radio" name="rules[des_dir]" value="0" <?php echo ($setting['r_des_dir']==0)?'checked':''?>>Нет 
                                </label>
                              </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <select name="u_cat" id="action-3" class="form-control">
                                  <option value="0" <?php echo ($setting['u_cat']==0)?'selected':''?>>Не обновлять категории</option>
                                  <option value="1" <?php echo ($setting['u_cat']==1)?'selected':''?>>Создавать категории и обновлять в товаре</option>
                                  <option value="2" <?php echo ($setting['u_cat']==2)?'selected':''?>>Не создавать новые категории, но обновлять если категория уже создана</option>
                                  <option value="3" <?php echo ($setting['u_cat']==3)?'selected':''?>>Создавать, и добавлять товар в дополнительные новые категории</option>
                                </select>
                              </div>
                              ...
                              <div class="col-sm-4">
                                <select name="rules[cat]" id="action-3" class="form-control">
                                  <option value="0" <?php echo ($setting['r_cat']==0)?'selected':''?>>Не заполнять [Не рекомендую, товар получит категорию с id = 0]</option>
                                  <option value="1" <?php echo ($setting['r_cat']==1)?'selected':''?>>Создавать категории и заполнять в товаре</option>
                                  <option value="2" <?php echo ($setting['r_cat']==2)?'selected':''?>>Заполнить категорию в товаре только если категория уже создана в магазине</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input id="cat" class="form-control" name="cat" type="text" value="<?php echo @$setup['cat']?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                                <select class="form-control" id="value-border-4"
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <select class="form-control" name="r_cat_perent">
                                  <option value="0"
                                  <?php echo ($setting['r_cat_perent'] == 0)?'selected':''?>>Только в младшей
                                  категории</option>
                                  <option value="1"
                                  <?php echo ($setting['r_cat_perent'] == 1)?'selected':''?>>В младшей и родительской
                                  категории</option>
                                  <option value="2"
                                  <?php echo ($setting['r_cat_perent'] == 2)?'selected':''?>>В младшей и во всех
                              ...
                              <div class="col-sm-10">
                                <select class="form-control" name="cat_d">
                                  ...
                                  <?php foreach($categorys as $key => $category){?>
                                    <option value="<?php echo $key?>" <?php echo (!empty($setup['cat_d']) && $setup['cat_d'] == $key)?'selected':''?>><?php echo $category?></option>
                                    <?php }?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select name="r_cat_made_url" class="form-control" id="value-border-3">
                                  <option value="1"
                                  <?php echo ($setting['r_cat_made_url'] == 1)?'selected':''?>>Формировать из
                                  названия</option>
                                  <option value="2"
                                  <?php echo ($setting['r_cat_made_url'] == 2)?'selected':''?>>По SEO шаблону</option>
                                  <option value="0"
                                  <?php echo ($setting['r_cat_made_url'] == 0)?'selected':''?>>Не создавать</option>
                                </select>
                              </div>
                              <label class="col-sm-2 control-label" for="by-default-3">Заполнять метаданные</label>
                              <div class="col-md-2">
                                <select name="r_cat_made_meta" class="form-control">
                                  <option value="0"
                                  <?php echo ($setting['r_cat_made_meta'] == 0)?'selected':''?>>Не заполнять</option>
                                  <option value="1"
                                  <?php echo ($setting['r_cat_made_meta'] == 1)?'selected':''?>>По SEO шаблону</option>
                                </select>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <select name="u_img" id="to-renew-5" class="form-control">
                                  <option value="0" <?php echo ($setting['u_img']==0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['u_img']==1)?'selected':''?>>Заменит все изображения товара (Без физического удаления изображений с хостинга)</option>
                                  <option value="2" <?php echo ($setting['u_img']==2)?'selected':''?>>Заменит все изображения товара (С удалением изображений с диска. Будут удалены изображения что привязаны к товару в момент обновления)</option>
                                  <option value="3" <?php echo ($setting['u_img']==3)?'selected':''?>>Добавлять дополнительные изображения при обновлении (Внимание!!! Не производится проверка на дубли!!!)</option>
                                  <option value="4" <?php echo ($setting['u_img']==4)?'selected':''?>>Добавлять изображения если в товаре их нет</option>
                                </select>
                              </div>
                              ...
                              <div class="col-sm-4">
                                <select name="rules[img]" id="to-renew-5" class="form-control">
                                  <option value="0"  <?php echo ($setting['r_img']==0)?'selected':''?>>Не добавлять</option>
                                  <option value="1" <?php echo ($setting['r_img']==1)?'selected':''?>>Добавлять</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <label class="radio-inline">
                                  <input type="radio" name="rules[img_dir]"
                                         value="1" <?php echo ($setting['r_img_dir']==1)?'checked':''?>>
                                  Да </label>
                                <label class="radio-inline">
                                  <input type="radio" name="rules[img_dir]"
                                         value="0" <?php echo ($setting['r_img_dir']==0)?'checked':''?>>
                                  Нет </label>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <select name="u_attr" id="to-renew-6" class="form-control">
                                  <option value="0" <?php echo ($setting['u_attr']==0)?'selected':''?>>Не работать с атрибутами</option>
                                  <option value="1" <?php echo ($setting['u_attr']==1)?'selected':''?>>Создавать/Добавлять/Обновлять атрибуты</option>
                                  <option value="2" <?php echo ($setting['u_attr']==2)?'selected':''?>>Добавить/Обновить атрибуты в товаре, не создавать новые</option>
                                  <option value="3" <?php echo ($setting['u_attr']==3)?'selected':''?>>Добавить новый не обновлять существующие, не создавать новые</option>
                                  <option value="4" <?php echo ($setting['u_attr']==4)?'selected':''?>>Обновить значения существующих атрибутов, не добавлять, не создавать новые</option>
                                  <option value="5" <?php echo ($setting['u_attr']==5)?'selected':''?>>Удалить все атрибуты в товаре и загрузить заново</option>
                                </select>
                              </div>
                              ...
                              <div class="col-sm-4">
                                <select name="rules[attr]" id="to-renew-6" class="form-control">
                                  <option value="0"  <?php echo ($setting['r_attr']==0)?'selected':''?>>Не работать с атрибутами</option>
                                  <option value="1" <?php echo ($setting['r_attr']==1)?'selected':''?>>Создавать атрибуты если таких нет, добавлять атрибуты в товар</option>
                                  <option value="2" <?php echo ($setting['r_attr']==2)?'selected':''?>>Добавлять в товар без создания новых атрибутов</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <select class="form-control" name="r_attr_group">
                                  ...
                                  <?php foreach ($attr_groups as $key => $attr_g) { ?>
                                  <option value="<?php echo $key?>"
                                  <?php echo ($setting['r_attr_group']==$key)?'selected':''?>
                                  ><?php echo $attr_g?></option>
                                  <?php }?>
                                </select>
                              </div>
                            </div>
                                ...
                                <div class="form-group">
                                  <div class="col-sm-2">
                                    ...
                                    <select name="u_opt" id="to-renew-6" class="form-control">
                                      <option value="0" <?php echo ($setting['u_opt']==0)?'selected':''?>>Не работать с опциями</option>
                                      <option value="1" <?php echo ($setting['u_opt']==1)?'selected':''?>>Обновить значения существующих опций</option>
                                      <option value="2" <?php echo ($setting['u_opt']==2)?'selected':''?>>Добавить новые опции и обновить существующие</option>
                                      <option value="3" <?php echo ($setting['u_opt']==3)?'selected':''?>>Добавить новый не обновлять существующие</option>
                                      <option value="4" <?php echo ($setting['u_opt']==4)?'selected':''?>>Удалить все опции и загрузить заново</option>
                                    </select>
                                  </div>
                                  <div class="col-sm-2"></div>
                                  <div class="col-sm-2">
                                    ...
                                    <select name="r_opt" id="to-renew-6" class="form-control">
                                      <option value="0" <?php echo ($setting['r_opt']==0)?'selected':''?>>Не работать с опциями</option>
                                      <option value="1" <?php echo ($setting['r_opt']==1)?'selected':''?>>Создавать, заполнять в товар</option>
                                      <option value="2" <?php echo ($setting['r_opt']==2)?'selected':''?>>Заполнять в товаре без создания новых опций и значений опций</option>
                                    </select>
                                  </div>
                                </div>
                                <?php foreach ($setup['opts'] as $opt_key => $opt) {?>
                                <div class="row" id="recurring-row-<?php echo @$opt_key?>">
                                  <div class="form-group">
                                    <div class="col-sm-2 col-lg-2">
                                      <label for="">&nbsp;</label>
                                      <select class="form-control" name="opts[<?php echo $opt_key?>][data][required]">
                                        <option value="0" <?php echo ($opt['data']['required'] == '0')?'selected':''?>>Не обязательная опция</option>
                                        <option value="1" <?php echo ($opt['data']['required'] == '1')?'selected':''?>>Обязательная опция</option>
                                      </select>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="col-sm-5">
                                      ...
                                      <input id="name_<?php echo $opt_key?>" name="opts[<?php echo $opt_key?>][name]" type="text" value="<?php echo $opt['name']?>" class="form-control">
                                    </div>
                                    <div class="col-sm-2">
                                      <label for="input-link">&nbsp;</label>
                                      <select class="form-control" id="value-border-1" onchange="document.getElementById('name_<?php echo $opt_key?>').value+=value+''">
                                        <option value="">Выберите границу парсинга</option>
                                        <?php foreach($params as $param){ ?>
                                          <option value="{gran_<?php echo $param['id']?>}">
                                            <?php echo $param['name']. '| {gran_'.$param['id'].'}'?>
                                    ...
                                    <div class="col-sm-2">
                                      ...
                                      <select class="form-control" name="opts[<?php echo $opt_key?>][opt_id]">
                                        <option value="0">Выберите опцию</option>
                                        <?php foreach ($options as $option) {?>
                                          <option value="<?php echo $option['option_id']?>" <?php echo ($opt['opt_id'] == $option['option_id'])?'selected':''?>><?php echo $option['name']?></option>
                                        <?php }?>
                                       </select>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="col-sm-5">
                                      ...
                                      <input id="value_<?php echo $opt_key?>" name="opts[<?php echo $opt_key?>][value]" type="text" value="<?php echo $opt['value']?>" class="form-control">
                                    </div>
                                    <div class="col-sm-2">
                                      <label for="input-link">&nbsp;</label>
                                      <select class="form-control" id="value-border-1" onchange="document.getElementById('value_<?php echo $opt_key?>').value+=value+''">
                                        <option value="">Выберите границу парсинга</option>
                                        <?php foreach($params as $param){ ?>
                                        <option value="{gran_<?php echo $param['id']?>}">
                                          <?php echo $param['name']. '| {gran_'.$param['id'].'}'?>
                                  ...
                                  <div class="form-group">
                                    <div class="col-sm-5">
                                      ...
                                      <input id="price_<?php echo $opt_key?>" name="opts[<?php echo $opt_key?>][price]" type="text" value="<?php echo $opt['price']?>" class="form-control">
                                    </div>
                                    <div class="col-sm-2">
                                      <label for="input-link">&nbsp;</label>
                                      <select class="form-control" id="value-border-1" onchange="document.getElementById('price_<?php echo $opt_key?>').value+=value+''">
                                        <option value="">Выберите границу парсинга</option>
                                        <?php foreach($params as $param){ ?>
                                          <option value="{gran_<?php echo $param['id']?>}">
                                            <?php echo $param['name']. '| {gran_'.$param['id'].'}'?> 
                                    ...
                                    <div class="col-sm-2 col-lg-2">
                                      ...
                                      <select class="form-control" name="opts[<?php echo $opt_key?>][data][price_prefix]">
                                        <option value="+" <?php echo ($opt['data']['price_prefix'] == '+')?'selected':''?>>(+) Плюс к цене</option>
                                  ...
                                  <div class="form-group">
                                    <div class="col-sm-5">
                                      ...
                                      <input id="quant_<?php echo $opt_key?>"name="opts[<?php echo $opt_key?>][quant]" type="text" value="<?php echo $opt['quant']?>" class="form-control">
                                    </div>
                                    <div class="col-sm-2">
                                      <label for="input-link">&nbsp;</label>
                                      <select class="form-control" id="value-border-1" onchange="document.getElementById('quant_<?php echo $opt_key?>').value+=value+''">
                                        <option value="">Выберите границу парсинга</option>
                                        <?php foreach($params as $param){ ?>
                                          <option value="{gran_<?php echo $param['id']?>}">
                                            <?php echo $param['name']. '| {gran_'.$param['id'].'}'?>
                                    ...
                                    <div class="col-sm-2 col-lg-2">
                                      ...
                                      <input id="quant_d_<?php echo $opt_key?>"name="opts[<?php echo $opt_key?>][quant_d]" type="text" value="<?php echo $opt['quant_d']?>" class="form-control">
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    <div class="col-sm-5">
                                      ...
                                      <input id="imgs_<?php echo $opt_key?>" name="opts[<?php echo $opt_key?>][imgs]" type="text" value="<?php echo @$opt['imgs']?>" class="form-control">
                                    </div>
                                    <div class="col-sm-2">
                                      <label for="input-link">&nbsp;</label>
                                      <select class="form-control" id="value-border-1" onchange="document.getElementById('imgs_<?php echo $opt_key?>').value+=value+''">
                                        <option value="">Выберите границу парсинга</option>
                                        <?php foreach($params as $param){ ?>
                                        <option value="{gran_<?php echo $param['id']?>}">
                                          <?php echo $param['name']. '| {gran_'.$param['id'].'}'?>
                                    ...
                                    <div class="col-sm-2 col-lg-2">
                                      ...
                                      <select class="form-control" name="opts[<?php echo $opt_key?>][data][imgs_type]">
                                        <option value="0" <?php echo ($opt['data']['imgs_type'] == '0')?'selected':''?>>Не использовать</option>
                                        <option value="1" <?php echo ($opt['data']['imgs_type'] == '1')?'selected':''?>>По стандарту Opencart</option>
                                        <option value="2" <?php echo ($opt['data']['imgs_type'] == '2')?'selected':''?><?php echo ($option_module_img == 1)?'':' disabled=""'?>>Модуль опций от HyperLabTeam</option>
                                        <option value="3" <?php echo ($opt['data']['imgs_type'] == '3')?'selected':''?><?php echo ($option_module_img == 2)?'':' disabled=""'?>>Изображения опций PRO от 19th</option>
                                      </select>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    <div class="col-sm-4">
                                      ...
                                      <?php if ($opt_key != 0) {?>
                                        <button type="button" onclick="$('#recurring-row-<?php echo $opt_key?>').remove()"data-toggle="tooltip"
                          ...
                          <div class="tab-pane" id="tab-option11">
                            <div class="form-group">
                              <label class="col-sm-2 control-label" for="to-renew-5">При обновлении:<span data-toggle="tooltip" data-original-title="Выберите какое действие необходимо выполнить модулю с этим полем в момент обновления товара."></span></label>
                              <div class="col-sm-4">
                                <select name="u_file" id="to-renew-5" class="form-control">
                                  <option value="0" <?php echo ($setting['u_file']==0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['u_file']==1)?'selected':''?>>Заменить все файлы (С физическим удалением с хостинга. Будут удалены файлы что привязаны к товару в момент обновления))</option>
                                  <option value="2" <?php echo ($setting['u_file']==2)?'selected':''?>>Заменит все файлы в товара (Без физического удаления файлов с хостинга)</option>
                                </select>
                              </div>
                              <label class="col-sm-2 control-label" for="to-renew-5">При добавлении:<span data-toggle="tooltip" data-original-title="Выберите какое действие необходимо выполнить модулю с этим полем в момент добавления нового товара."></span></label>
                              <div class="col-sm-4">
                                <select name="rules[file]" id="to-renew-5" class="form-control">
                                  <option value="0"  <?php echo ($setting['r_file']==0)?'selected':''?>>Не добавлять</option>
                                  <option value="1" <?php echo ($setting['r_file']==1)?'selected':''?>>Добавлять</option>
                                </select>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 control-label" for="file">Файлы =</label>
                              <div class="col-sm-6">
                                <input id="file" class="form-control" name="file" type="text"
                                       value="<?php echo @$setup['file']?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                                <select class="form-control" id="value-border-4"
                                        onchange="document.getElementById('file').value+=value+''">
                                  <option value="">Выберите границу парсинга</option>
                                  <?php foreach($params as $param){ ?>
                                    <option value="{gran_<?php echo $param['id']?>}">
                                      <?php echo $param['name']. '| {gran_'.$param['id'].'}'?>
                            ...
                            <div class="form-group">
                              <label class="col-sm-2 control-label" for="file_dir">Директория для фото <span
                                        data-toggle="tooltip"
                                        data-original-title="Существующая директория для загрузки файлов товара (без system/storage/download/). Так же возможно использование границ парсинга для создания директорий. Любой текст в границе парсинга транслируется в латиницу. Повторяющиеся границы парсинга преобразовываются в вложенные папки. Пример 'Категория{csvnc}Под категория' => 'kategoriya/pod_kategoriya'"></span></label>
                              <div class="col-sm-3">
                                <input id="file_dir" class="form-control" name="file_dir" type="text"
                                       value="<?php echo @$setup['file_dir']?>">
                              </div>
                              <div class="col-sm-3"></div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                                <select class="form-control" id="value-border-4"
                                        onchange="document.getElementById('file_dir').value+=value+''">
                                  <option value="">Выберите границу парсинга</option>
                                  <?php foreach($params as $param){ ?>
                                    <option value="{gran_<?php echo $param['id']?>}">
                                      <?php echo $param['name']. '| {gran_'.$param['id'].'}'?>
                          ...
                          <div class="tab-pane" id="tab-option12">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_upc">
                                  <option value="0" <?php echo ($setting['r_upc'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_upc'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--EAN-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="ean" name="ean" type="text" value="<?php echo @$setup['ean'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_ean">
                                  <option value="0" <?php echo ($setting['r_ean'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_ean'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--JAN-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="jan" name="jan" type="text" value="<?php echo @$setup['jan'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_jan">
                                  <option value="0" <?php echo ($setting['r_jan'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_jan'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--ISBN-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="isbn" name="isbn" type="text" value="<?php echo @$setup['isbn'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_isbn">
                                  <option value="0" <?php echo ($setting['r_isbn'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_isbn'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--MPN-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="mpn" name="mpn" type="text" value="<?php echo @$setup['mpn'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_mpn">
                                  <option value="0" <?php echo ($setting['r_mpn'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_mpn'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="location" name="location" type="text" value="<?php echo @$setup['location'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_location">
                                  <option value="0" <?php echo ($setting['r_location'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_location'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--Минимальное кол-во-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="minimum" name="minimum" type="text" value="<?php echo @$setup['minimum'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_minimum">
                                  <option value="0" <?php echo ($setting['r_minimum'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_minimum'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--Вычитать со склада-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="subtract">
                                  <option value="1" <?php echo ($setup['subtract'] == 1)?'selected':''?>>Да</option>
                                  <option value="0" <?php echo ($setup['subtract'] == 0)?'selected':''?>>Нет</option>
                                </select>
                              </div>
                              <div class="col-sm-6"> </div>
                              <div class="col-sm-2">
                                <select class="form-control" name="r_subtract">
                                  <option value="0" <?php echo ($setting['r_subtract'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_subtract'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--Размеры (Длина)-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="length" name="length" type="text" value="<?php echo @$setup['length'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select name="r_length" class="form-control">
                                  <option value="0" <?php echo ($setting['r_length'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_length'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--Размеры (Ширина)-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="width" name="width" type="text" value="<?php echo @$setup['width'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_width">
                                  <option value="0" <?php echo ($setting['r_width'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_width'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--Размеры (Высота)-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="height" name="height" type="text" value="<?php echo @$setup['height'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_height">
                                  <option value="0" <?php echo ($setting['r_height'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_height'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--Единица длины-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="length_class_id">
                                  ...
                                  <option value="<?php echo $length_class['length_class_id']?>" <?php echo ($length_class['length_class_id'] == $setup['length_class_id'])?'selected':''?>><?php echo $length_class['title'].' ('.$length_class['unit'].')'?></option>
                                  <?php }?>
                                </select>
                              </div>
                              <div class="col-sm-6"> </div>
                              <div class="col-sm-2">
                                <select class="form-control" name="r_length_class_id">
                                  <option value="0" <?php echo ($setting['r_length_class_id'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_length_class_id'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--Вес-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="weight" name="weight" type="text" value="<?php echo @$setup['weight'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_weight">
                                  <option value="0" <?php echo ($setting['r_weight'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_weight'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--Единица веса-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" id="weight_class_id" name="weight_class_id">
                                  ...
                                  <option value="<?php echo $weight_class['weight_class_id']?>" <?php echo ($weight_class['weight_class_id'] == $setup['weight_class_id'])?'selected':''?>><?php echo $weight_class['title'].' ('.$weight_class['unit'].')'?></option>
                                  <?php }?>
                                </select>
                              </div>
                              <div class="col-sm-6"> </div>
                              <div class="col-sm-2">
                                <select class="form-control" name="r_weight_class_id">
                                  <option value="0" <?php echo ($setting['r_weight_class_id'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_weight_class_id'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--Статус-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="status">
                                  <option value="1" <?php echo ($setup['status']==1)?'selected':''?>>Включен</option>
                                  <option value="2" <?php echo ($setup['status']==2)?'selected':''?>>Отключен</option>
                                  <option value="3" <?php echo ($setup['status']==3)?'selected':''?>>Отключить при нулевом остатке</option>
                                </select>
                              </div>
                              <div class="col-sm-6"> </div>
                              <div class="col-sm-2">
                                <select class="form-control" name="r_status">
                                  <option value="0" <?php echo ($setting['r_status'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_status'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_status_zero">
                                  <?php foreach($stock_status as $stock_statu){?>
                                  <option value="<?php echo $stock_statu['stock_status_id']?>" <?php echo (!empty($setting['r_status_zero']) && $setting['r_status_zero'] == $stock_statu['stock_status_id'])?'selected':''?>>
                                    <?php echo $stock_statu['name']?>  
                                  </option>
                                  <?php }?>
                                </select>
                              </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="sort_order" name="sort_order" type="text" value="<?php echo @$setup['sort_order'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_sort_order">
                                  <option value="0" <?php echo ($setting['r_sort_order'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_sort_order'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--Выбор макета товара-->
                            <div class="form-group">
                              <label class="col-sm-2 control-label">Выбор макета товара :</span></label>
                              <div class="col-sm-2">
                                <select class="form-control" name="layout_pr">
                                  <option value="0">Выберите макет</option>
                                  <?php foreach ($layouts as $layout) {?>
                                  <option value="<?php echo $layout['layout_id']?>" <?php echo ($layout['layout_id'] == $setup['layout_pr'])?'selected':''?>><?php echo $layout['name']?></option>
                                  <?php }?>
                                </select>
                              </div>
                              <div class="col-sm-6"> </div>
                              <div class="col-sm-2">
                                <select class="form-control" name="r_layout_pr">
                                  <option value="0" <?php echo ($setting['r_layout_pr'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_layout_pr'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="layout_cat">
                                  <option value="0">Выберите макет</option>
                                  <?php foreach ($layouts as $layout) {?>
                                  <option value="<?php echo $layout['layout_id']?>" <?php echo ($layout['layout_id'] == $setup['layout_cat'])?'selected':''?>><?php echo $layout['name']?></option>
                                  <?php }?>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="tags" name="tags" type="text" value="<?php echo @$setup['tags'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_tags">
                                  <option value="0" <?php echo ($setting['r_tags'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_tags'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input class="form-control" id="cost" name="cost" type="text" value="<?php echo @$setup['cost'];?>">
                              </div>
                              <label class="col-sm-2 control-label" for="value-border-4">Выбрать границу:</label>
                              <div class="col-sm-2">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_cost">
                                  <option value="0" <?php echo ($setting['r_cost'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_cost'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="related_sku">
                                  ...
                                  <option value="model" <?php echo ($setup['related_sku'] == 'model')?'selected':''?>>Model</option>
                                  <option value="sku" <?php echo ($setup['related_sku'] == 'sku')?'selected':''?>>SKU</option>
                                  <option value="upc" <?php echo ($setup['related_sku'] == 'upc')?'selected':''?>>UPC</option>
                                  <option value="ean" <?php echo ($setup['related_sku'] == 'ean')?'selected':''?>>EAN</option>
                                  <option value="jan" <?php echo ($setup['related_sku'] == 'jan')?'selected':''?>>JAN</option>
                                  <option value="isbn" <?php echo ($setup['related_sku'] == 'isbn')?'selected':''?>>ISBN</option>
                                  <option value="mpn" <?php echo ($setup['related_sku'] == 'mpn')?'selected':''?>>MPN</option>
                                  <option value="location" <?php echo ($setup['related_sku'] == 'location')?'selected':''?>>Location</option>
                                </select>
                              </div>
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_related">
                                  <option value="0" <?php echo ($setting['r_related'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_related'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="hpm_sku">
                                  ...
                                  <option value="model" <?php echo ($setup['hpm_sku'] == 'model')?'selected':''?><?php echo ($hpm_inst)?'':' disabled=""'?>>Model</option>
                                  <option value="sku" <?php echo ($setup['hpm_sku'] == 'sku')?'selected':''?><?php echo ($hpm_inst)?'':' disabled=""'?>>SKU</option>
                                  <option value="upc" <?php echo ($setup['hpm_sku'] == 'upc')?'selected':''?><?php echo ($hpm_inst)?'':' disabled=""'?>>UPC</option>
                                  <option value="ean" <?php echo ($setup['hpm_sku'] == 'ean')?'selected':''?><?php echo ($hpm_inst)?'':' disabled=""'?>>EAN</option>
                                  <option value="jan" <?php echo ($setup['hpm_sku'] == 'jan')?'selected':''?><?php echo ($hpm_inst)?'':' disabled=""'?>>JAN</option>
                                  <option value="isbn" <?php echo ($setup['hpm_sku'] == 'isbn')?'selected':''?><?php echo ($hpm_inst)?'':' disabled=""'?>>ISBN</option>
                                  <option value="mpn" <?php echo ($setup['hpm_sku'] == 'mpn')?'selected':''?><?php echo ($hpm_inst)?'':' disabled=""'?>>MPN</option>
                                  <option value="location" <?php echo ($setup['hpm_sku'] == 'location')?'selected':''?><?php echo ($hpm_inst)?'':' disabled=""'?>>Location</option>
                                </select>
                              </div>
                              <div class="col-sm-6" style="top: 10px;"> <span><b class="text-danger">Внимание!!!</b> 
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="r_hpm">
                                  <option value="0" <?php echo ($setting['r_hpm'] == 0)?'selected':''?>>Не обновлять</option>
                                  <option value="1" <?php echo ($setting['r_hpm'] == 1)?'selected':''?>>Обновлять</option>
                                </select>
                              </div>
                            </div>
                            <!--Работа с webp-->
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                <select class="form-control" name="webp_conv">
                                  ...
                                  <option value="1" <?php echo ($browser['webp_conv'] == 1)?'selected':''?>>Да, в формат jpeg</option>
                                  <option value="2" <?php echo ($browser['webp_conv'] == 2)?'selected':''?>>Да, в формат png</option>
                                </select>
                              </div>
                              <div class="col-sm-6" style="top: 10px;"> <span><b class="text-danger">Внимание!!!</b> 
                  ...
                  <div role="tabpanel" class="tab-pane fade" id="smpp__seo" aria-labelledby="profile-tab">
                    <legend>Товар</legend>
                      ...
                      <div class="col-sm-4">
                        <select name="u_made_meta" id="to-renew-6" class="form-control">
                          <option value="0" <?php echo ($setting['u_made_meta']==0)?'selected':''?>>Не обновлять</option>
                          <option value="1" <?php echo ($setting['u_made_meta']==1)?'selected':''?>>Обновить по сео шаблону</option>
                        </select>
                      </div>
                      <label class="col-sm-2 control-label" for="to-renew-6">При добавлении:<span data-toggle="tooltip" data-original-title="Выберите какое действие необходимо выполнить модулю с этим полем в момент добавления нового товара."></span></label>
                      <div class="col-sm-4">
                        <select name="r_made_meta" id="to-renew-6" class="form-control">
                          <option value="0"
                          <?php echo ($setting['r_made_meta']==0)?'selected':''?>>Не заполнять</option>
                          <option value="1"
                          <?php echo ($setting['r_made_meta']==1)?'selected':''?>>Заполнять</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="seo_h1" id="seo_h1" type="text" value="<?php echo @$setup['seo_h1']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="seo_title" id="seo_title" type="text" value="<?php echo @$setup['seo_title']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="seo_desc" id="seo_desc" type="text" value="<?php echo @$setup['seo_desc']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="seo_keyw" id="seo_keyw" type="text" value="<?php echo @$setup['seo_keyw']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <select name="u_up_url" id="to-renew-6" class="form-control">
                          <option value="0" <?php echo ($setting['u_up_url']==0)?'selected':''?>>Не обновлять</option>
                          <option value="1" <?php echo ($setting['u_up_url']==1)?'selected':''?>>Обновить</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        <select name="r_made_url" class="form-control" id="value-border-3">
                          <option value="1" <?php echo ($setting['r_made_url'] == 1)?'selected':''?>>Формировать из названия товара</option>
                          <option value="2" <?php echo ($setting['r_made_url'] == 2)?'selected':''?>>По SEO шаблону</option>
                          <option value="0" <?php echo ($setting['r_made_url'] == 0)?'selected':''?>>Не создавать/Не обновлять</option>
                        </select>
                      </div>
                      <label class="col-sm-1 control-label" for="input-pr">URL шаблон:</label>
                      <div class="col-sm-5">
                        <input name="seo_url" id="seo_url" type="text" value="<?php echo @$setup['seo_url']?>" id="input-pr" class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="img_name" id="img_name" type="text" value="<?php echo @$setup['img_name']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="cat_seo_url" id="cat_seo_url" type="text"
                               value="<?php echo @$setup['cat_seo_url']?>" class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="cat_seo_h1" id="cat_seo_h1" type="text" value="<?php echo @$setup['cat_seo_h1']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="cat_seo_title" id="cat_seo_title" type="text"
                               value="<?php echo @$setup['cat_seo_title']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="cat_seo_desc" id="cat_seo_desc" type="text"
                               value="<?php echo @$setup['cat_seo_desc']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="cat_seo_keyw" id="cat_seo_keyw" type="text"
                               value="<?php echo @$setup['cat_seo_keyw']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="manuf_seo_url" id="manuf_seo_url" type="text"
                               value="<?php echo @$setup['manuf_seo_url']?>" class="form-control">
                      </div>
                      <div class="col-sm-2">
                        <select class="form-control"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="manuf_seo_h1" id="manuf_seo_h1" type="text"
                               value="<?php echo @$setup['manuf_seo_h1']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="manuf_seo_title" id="manuf_seo_title" type="text"
                               value="<?php echo @$setup['manuf_seo_title']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                        <select class="form-control"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="manuf_seo_desc" id="manuf_seo_desc" type="text"
                               value="<?php echo @$setup['manuf_seo_desc']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                        <select class="form-control"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input name="manuf_seo_keyw" id="manuf_seo_keyw" type="text"
                               value="<?php echo @$setup['manuf_seo_keyw']?>"
                               class="form-control">
                      </div>
                      <div class="col-sm-2">
                        <select class="form-control"
...
<script type="text/javascript">
  var key_max = <?php echo $opt_key_max?>;
  ...
  function addRecurring() {
    ...
    <?php foreach($options as $option){
      echo 'html += \'<option value="'.$option["option_id"].'">'.$option["name"].'</option>\';'.PHP_EOL;
    }?>
    html +='</select>';
    html +='</div>';
    html +='</div>';
    ...
    html +='      <option value="2"<?php echo ($option_module_img == 1)?"":" disabled"?>>Модуль опций от HyperLabTeam</option>';
    html +='      <option value="3"<?php echo ($option_module_img == 2)?"":" disabled"?>>Изображения опций PRO от 19th</option>';
    html +='    </select>';
    html +='  </div>';
    html +='</div>';
...
<script type="text/javascript">
  $(document).ready(function () {
      ...
      function ajaxpars(time1, iter) {
        iter++;
        $.ajax({
          url: 'index.php?route=catalog/simplepars/parsajax&<?php echo $adap['token']?>&who=pr_im&dn_id=<?php echo $dn_id?>',
          type: "POST",
