        ...
        <div class="tab-content">
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-5">
                <input type="text" name="view_href2" id="view_href2"class="form-control" value="<?php echo $view_href?>" placeholder="Вставьте ссылку что бы увидеть результат парсинга.">
              </div>
              <div class="col-sm-1">
                <?php if ($view_href) {?>
          ...
          <div class="form-group">
            <div class="col-md-3">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <input id="pr_start" type="text" name="pr_start" class="form-control" value="<?php echo @$xml['pr_start']?>">
                  ...
                  <input type="text" id="pr_stop" name="pr_stop" class="form-control" value="<?php echo @$xml['pr_stop']?>">
                </div>
              </div>
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-sm-12"> 
                      ...
                      <select id="cat_work" class="form-control input-sm">
                        <option value="0" <?php echo ($xml['cat_work']==0)?'selected':''?>>Нет</option>
                        <option value="1" <?php echo ($xml['cat_work']==1)?'selected':''?>>Да</option>
                      </select>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <input id="cat_start" type="text" name="cat_start" class="form-control" value="<?php echo @$xml['cat_start']?>" placeholder="Текст начала парсинга">
                    </div>
                    <div class="col-sm-6" style="margin-top: 20px">
                      <input id="cat_stop" type="text" name="cat_stop" class="form-control" value="<?php echo @$xml['cat_stop']?>" placeholder="Текст конца парсинга">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <input id="cat_name_start" type="text" name="cat_name_start" class="form-control" value="<?php echo @$xml['cat_name_start']?>" placeholder="Текст начала парсинга">
                    </div>
                    <div class="col-sm-6" style="margin-top: 20px">
                      <input id="cat_name_stop" type="text" name="cat_name_stop" class="form-control" value="<?php echo @$xml['cat_name_stop']?>" placeholder="Текст конца парсинга">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <input id="cat_id_start" type="text" name="cat_id_start" class="form-control" value="<?php echo @$xml['cat_id_start']?>" placeholder="Текст начала парсинга">
                    </div>
                    <div class="col-sm-6" style="margin-top: 20px">
                      <input id="cat_id_stop" type="text" name="cat_id_stop" class="form-control" value="<?php echo @$xml['cat_id_stop']?>" placeholder="Текст конца парсинга">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <input id="cat_perent_start" type="text" name="cat_perent_start" class="form-control" value="<?php echo @$xml['cat_perent_start']?>" placeholder="Текст начала парсинга">
                    </div>
                    <div class="col-sm-6" style="margin-top: 20px">
                      <input id="cat_perent_stop" type="text" name="cat_perent_stop" class="form-control" value="<?php echo @$xml['cat_perent_stop']?>" placeholder="Текст конца парсинга">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <input id="cat_delim" type="text" name="cat_delim" class="form-control" value="<?php echo @$xml['cat_delim']?>" placeholder="К примеру {csvnc}">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <input id="pr_cat_start" type="text" name="pr_cat_start" class="form-control" value="<?php echo @$xml['pr_cat_start']?>" placeholder="Текст начала парсинга">
                    </div>
                    <div class="col-sm-6" style="margin-top: 20px">
                      <input id="pr_cat_stop" type="text" name="pr_cat_stop" class="form-control" value="<?php echo @$xml['pr_cat_stop']?>" placeholder="Текст конца парсинга">
                    </div>
                  </div>
                  <br>
                  <div class="row">
            ...
            <div class="col-md-9">
              ...
              <pre style="max-height: 750px; overflow: auto; padding: 5px" title="Code block"><code id="page_code"><?php echo $page_code?></code><code id="piece_code" hidden></code></pre>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-md-12">
              ...
              <div class="col-md-6">
                ...
                <textarea rows="6" id="filter_yes" class="col-sm-6 form-control"><?php echo @$xml['filter_yes']?></textarea>
              </div>
              <div class="col-md-6">
                <label class="control-label">Чего в товарах быть не должно<span data-toggle="tooltip" data-original-title="
                Укажите какого текста в товаре быть не должен что бы модуль его добавил. Правил может быть сколько угодно. Каждое правило должно начинаться с новой строки. Между двумя условиями стоит логическое ИЛИ. Поддерживаются регулярные выражения."></span></label>
                <textarea rows="6" id="filter_no" class="col-sm-6 form-control"><?php echo @$xml['filter_no']?></textarea>
              </div>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    function ajaxGetCode(value) {
      var retVal;
      $.ajax({
        url: 'index.php?route=catalog/simplepars/ajax&who=splitxml&<?php echo $adap['token']?>&dn_id=<?php echo $dn_id?>',
        type: "POST",
        data: value,
        async: false,
        dataType: "html",
  ...
  function url_ajax(data){
    // /var answ;
    $.ajax({
      url: 'index.php?route=catalog/simplepars/ajax&<?php echo $adap['token']?>&who=get_urls_sen&dn_id=<?php echo $dn_id?>',
      type: "POST",
      data: data,
      async: false,
      dataType: "html",
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    function ajaxpars(time1, iter) {
      iter++;
      $.ajax({
        url: 'index.php?route=catalog/simplepars/parsajax&<?php echo $adap['token']?>&who=pr_xml&dn_id=<?php echo $dn_id?>',
        type: "POST",
