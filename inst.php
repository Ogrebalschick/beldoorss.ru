...
$stmt = $dbh->prepare("ALTER TABLE `" . $pr . "pars_setting`
ADD `u_file` int(2) NOT NULL DEFAULT '0' AFTER `u_opt`,
ADD `r_file` int(11) NOT NULL DEFAULT '0' AFTER `r_opt`");
$stmt->execute();

$stmt = $dbh->prepare("ALTER TABLE `" . $pr . "pars_prsetup`
ADD `file` text COLLATE 'utf8_general_ci' NOT NULL AFTER `opt_data`,
ADD `file_dir` varchar(100) COLLATE 'utf8_general_ci' NOT NULL DEFAULT 'product' AFTER `file`");
$stmt->execute();
